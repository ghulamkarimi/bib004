...
const Person = () => {
  ...
  return (
    <div className=" flex flex-col mt-32 mb-44 gap-6 justify-center items-center text-center h-screen ">
      <h1 className="text-2xl font-bold">Personal Information </h1>
      <div
        className="flex flex-col w-[400px]  border-b border-t rounded-2xl bg-slate-600 text-center"
        key={person?.id}
      >
        <img
          className="  rounded-t-2xl w-[400px] h-[450px] object-cover "
          src={`../image/${person?.imageUrl}.avif`}
          alt=""
        />
